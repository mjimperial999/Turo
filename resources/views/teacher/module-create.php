...
<body>
    ...
    if (!$blobData) {
        $backgroundImage = "/images/no-image.jpeg";
    } else {
    ...
    <div class="screen">
        <div class="spacing main">
            <form method="POST" action="/teachers-panel/course/<?= $course->course_id ?>/section/<?= $section->section_id ?>/store-module" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                        ...
                        <div class="content padding main box-page">
                            <div class="content flex-column">
                                ...
                                <div class="form-box">
                                    ...
                                    <div class="form-input">
                                        <textarea type="text" name="module_description"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="content-container">
                    <div class="content">
                        <div class="form-button">
                            <button class="edit" onclick="return confirm('Create a new module?');">Create Module</button>
                        </div>
                    </div>
                </div>
            </form>

...
<script>
    ...
    let qIdx = <?= count($activity->quiz->questions) ?>; // start after last
...
<body>
    ...
    <div class="screen">
        <div class="spacing main">
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="content-container box-page">
                    <div class="mini-navigation">
                        ...
                        <div class="text title">
                            <h6>Edit <?= $activity->activity_name ?></h6>
                ...
                <div class="content-container">
                    ...
                    <div class="content padding box-gray">
                        ...
                        <div class="header">
                            <div class="text title">
                                <h4> Edit Short Quiz: <?= $activity->activity_name ?> </h4>
                            </div>
                        </div>
                    ...
                    <div class="content padding box-page">
                        <div class="content flex-column">
                            <div class="form-box">
                                ...
                                <div class="form-input"><input type="text" name="quiz_name" value="<?= htmlspecialchars($activity->activity_name) ?>" required></div>
                            </div>
                            ...
                            <div class="form-box">
                                ...
                                <div class="form-input"><input type="number" name="number_of_questions" min="1" value="<?= $activity->quiz->number_of_questions ?>" required></div>
                            </div>

                            <div class="form-box">
                                <div class="form-label"><label>Time Limit (minutes):</label></div>
                                <div class="form-input"><input type="number" name="time_limit_minutes" min="1" value="<?= $activity->quiz->time_limit / 60 ?>" required></div>
                            </div>

                            <div class="form-box">
                                <div class="form-label"><label>Unlock Date:</label></div>
                                <div class="form-input"><input type="datetime-local" name="unlock_date" value="<?= $activity->unlock_date ?>" required></div>
                            </div>

                            <div class="form-box">
                                <div class="form-label"><label>Deadline:</label></div>
                                <div class="form-input"><input type="datetime-local" name="deadline_date" value="<?= $activity->deadline_date ?>" required></div>
                            </div>

                            <div class="form-box">
                                <div class="form-label checkbox"><label>Show Answers After Submission:</label></div>
                                <div class="form-input"><input type="checkbox" name="has_answers_shown" value="1" <?= $activity->quiz->has_answers_shown ? 'checked' : '' ?>></div>
                            </div>
                                        ...
                                        <?php foreach ($q->options as $oi => $opt): ?>
                                            <div class="opt-row">
                                                ...
                                                <input type="hidden"
                                                    ...
                                                    value="<?= $opt->option_id ?>" data-repl="oid">
                ...
                <div class="content-container">
                    <div class="content">
                        <div class="form-button">
                            <button class="edit" onclick="return confirm('Edit short quiz?');">Save Changes</button>
                        </div>
                    </div>
                </div>
            ...
            <form method="POST" action="/teachers-panel/course/<?= $course->course_id ?>/section/<?= $section->section_id ?>/module/<?= $module->module_id ?>/shortquiz/<?= $activity->activity_id ?>/delete"

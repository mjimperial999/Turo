...
<body>
    ...
    <div class="screen">
        <div class="spacing main">
            <form method="POST" action="/teachers-panel/course/<?= $course->course_id ?>/section/<?= $section->section_id ?>/module/<?= $module->module_id ?>/store-shortquiz" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                ...
                <div class="content-container">
                    <div class="content">
                        <div class="form-button">
                            <button class="edit" onclick="return confirm('Create a new short quiz?');">Create Short Quiz</button>
                        </div>
                    </div>
                </div>

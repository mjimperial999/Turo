...
<body>
    ...
    <div class="screen">
        <div class="spacing main">
            <form method="POST" action="/teachers-panel/course/<?= $course->course_id ?>/section/<?= $section->section_id ?>/module/<?= $module->module_id ?>/store-practicequiz" enctype="multipart/form-data">
                <?= csrf_field(); ?>

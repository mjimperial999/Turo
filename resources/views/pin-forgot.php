        ...
        <div class="login admin">
            <div class="login-container">
                ...
                <div class="login-form">
                    ...
                    <form action="/forgot-password/send" method="POST" class="login-form-box" style="margin-bottom:1rem">
                        <?= csrf_field() ?>
                    ...
                    <form action="/forgot-password/verify" method="POST" class="login-form-box">
                        <?= csrf_field() ?>

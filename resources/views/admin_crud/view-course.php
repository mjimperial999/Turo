        ...
        <div class="spacing main">
            ...
            <div class="content-container">
                <div class="content padding heading box-gray crud">
                    ...
                    <div class="crud-header">
                        <form action="/admin-panel/edit-content/course/<?= $course->course_id ?>/create-module" method="GET">
            ...
            <div class="content-container">
                <div class="content padding heading box-gray crud">
                    ...
                    <div class="crud-header">
                        <form action="/admin-panel/edit-content/course/<?= $course->course_id ?>/create-longquiz" method="GET">
                            <button type="submit" class="crud-button-add">
            ...
            <div class="content-container box-page">
                <div class="content padding heading box-gray crud">
                    ...
                    <div class="crud-header">
                        <form action="/admin-panel/edit-content/course/<?= $course->course_id ?>/create-screening" method="GET">
                            <button type="submit" class="crud-button-add">

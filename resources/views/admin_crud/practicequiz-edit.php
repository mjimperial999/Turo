...
<body>
    ...
    <div class="screen">
        <div class="spacing main">
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="content-container">
                    ...
                    <div class="content padding box-gray">
                        ...
                        <div class="header">
                            <div class="text title">
                                <h4> Edit Practice Quiz: <?= $activity->activity_name ?> </h4>
                            </div>
                        </div>
                ...
                <div class="content-container">
                    <div class="content">
                        <div class="form-button">
                            <button class="edit" onclick="return confirm('Edit practice quiz?');">Save Changes</button>
                        </div>
                    </div>
                </div>
            ...
            <form method="POST" action="/admin-panel/edit-content/course/<?= $course->course_id ?>/module/<?= $module->module_id ?>/practicequiz/<?= $activity->activity_id ?>/delete"
                onsubmit="return confirm('Really delete this long quiz?');">
                <?= csrf_field(); ?>
                <div class="content-container">
                    <div class="content">
                        <div class="form-button delete">
                            <button class="delete" onclick="return confirm('Delete this practice quiz?');">Delete Practice Quiz</button>
                        </div>
                    </div>
                </div>
            </form>

                ...
                <div class="content padding heading box-gray crud">
                    ...
                    <div class="crud-buttons">
                        <div class="crud-header">
                            <form action="/admin-panel/edit-content/course/<?= $course->course_id ?>/module/<?= $module->module_id ?>/create-lecture" method="GET">
                        ...
                        <div class="crud-header">
                            <form action="/admin-panel/edit-content/course/<?= $course->course_id ?>/module/<?= $module->module_id ?>/create-tutorial" method="GET">
                                <button type="submit" class="crud-button-add">
            ...
            <div class="content-container box-page activities-content">
                <div class="content padding heading box-gray crud">
                    ...
                    <div class="crud-buttons">
                        ...
                        <div class="crud-header">
                            <form action="/admin-panel/edit-content/course/<?= $course->course_id ?>/module/<?= $module->module_id ?>/create-practicequiz" method="GET">
                                <button type="submit" class="crud-button-add">
            ...
            <div class="content-container box-page activities-content">
                <div class="content padding heading box-gray crud">
                    ...
                    <div class="crud-buttons">
                        ...
                        <div class="crud-header">
                            <form action="/admin-panel/edit-content/course/<?= $course->course_id ?>/module/<?= $module->module_id ?>/create-shortquiz" method="GET">
                                <button type="submit" class="crud-button-add">

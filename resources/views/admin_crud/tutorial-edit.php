                    ...
                    <div class="content padding main box-page">
                        <div class="content flex-column">
                            ...
                            <div class="form-box">
                                ...
                                <div class="form-input">
                                    <input id="name" type="text" name="video_url" value="<?= htmlspecialchars($activity->tutorial->video_url) ?>" required>
                                </div>
                            </div>
                            ...
                            <div style="margin-top:1rem">
                                <iframe width="100%" height="315"
                                    src="<?= preg_replace('/watch\?v=/', 'embed/', $activity->tutorial->video_url) ?>"
            ...
            <div class="content-container">
                <div class="content">
                    <form method="POST" action="/admin-panel/edit-content/course/<?= $course->course_id ?>/module/<?= $module->module_id ?>/delete"
                        onsubmit="return confirm('Really delete this tutorial?');">
                        <?= csrf_field(); ?>
                        <div class="form-button">
                            <button class="delete">Delete Tutorial Video</button>
                        </div>
                    </form>
                </div>
            </div>

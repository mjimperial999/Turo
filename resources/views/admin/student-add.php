<?php $title = "Create Student Account";
...
<body>
    ...
    <div class="screen">
        ...
        <div class="spacing whole">
            <form action="/admin-panel/student-list/add" method="POST">
                <?= csrf_field() ?>
                ...
                <div class="content-container">
                    <div class="content">
                        <div class="form-button">
                            <button class="edit" onclick="return confirm('Create a new account?');">Create Student</button>
                        </div>
                    </div>
                </div>

...
if (session('role_id') == 1) {
    ...
    echo
    '<div class="quiz-flex-box">
    <form action="/teachers-panel/course/'. $course->course_id .'/module/' . $module->module_id . '/practicequiz/' . $activity->activity_id . '" method="GET">
    ...
    <div class="quiz-crud">
                <div class="box-button">
                    <form action="/teachers-panel/course/' . $course->course_id .'/module/' . $module->module_id . '/practicequiz/' . $activity->activity_id . '/edit" method="GET">
                ...
                <div class="box-button delete">
                    <form action="/teachers-panel/course/' . $course->course_id .'/module/' . $module->module_id . '/practicequiz/' . $activity->activity_id. '/delete" method="POST"

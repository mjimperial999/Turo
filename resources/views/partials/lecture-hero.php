...
if (session('role_id') == 1) {
    if ($isAvailable) {
        ...
        <form action="/home-tutor/course/'. $course->course_id .'/module/' . $module->module_id . '/lecture/' . $activity->activity_id . '" method="GET">
        <button class="lecture-box lecture">
            <div class="lecture-title">
                <div class="logo">
                    <img class="svg" src="/icons/lecture.svg" width="42em" height="auto" />
                </div>
